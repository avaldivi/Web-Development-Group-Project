...
function edt_id(id)
{
 ...
 {
  window.location.href='student_edit_student.php?edit_id='+id;
 }
}
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="studentview.php">Main</a>
...
<div id="body">
 <div id="content">
    <label>Student View <a href="#" target="_blank"></a></label>
    </div>
    ...
    <table align="center">
    <tr>
    <th colspan="5"><a href="student_add_student.php">Add Student Info.</a></th>
    </tr>
	<th>Student ID</th>
	<th>Level </th>
    <th>Major</th>
