...
{
 $sql_query="DELETE FROM student WHERE student_id=".$_GET['delete_id'];
...
function edt_id(id)
{
 ...
 {
  window.location.href='admin_edit_student.php?edit_id='+id;
 }
}
function delete_id(id)
{
 ...
 {
  window.location.href='adminview_st.php?delete_id='+id;
 }
}
</script>
</head>
...
<div id="body">
 <div id="content">
    ...
    <table align="center">
    <tr>
    <th colspan="5"><a href="add_student.php">Add Students.</a></th>
    </tr>
	<th>Student ID</th>
	<th>Level </th>
    <th>Major</th>
