...
$sql_query = "INSERT INTO accounts(lastname,firstname,email,gender,phone,username,password,role) 
			VALUES('$lastname', '$firstname', '$email', '$gender', '$phone', '$username', '$password', 0)" ; 
 // sql query for inserting data into database
 ...
 if(mysqli_query($connection, $sql_query))
 {
  ...
  alert('User Created. Login to add your student info');
...
<div id="body">
 <div id="content">
    ...
    <table align="center">
    <tr>
    <td align="center"><a href="index.html">Cancel</a></td>
    </tr>
    <tr>
