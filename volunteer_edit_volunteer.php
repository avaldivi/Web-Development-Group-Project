...
{
 $sql_query="SELECT * FROM volunteer WHERE volunteer_id=".$_GET['edit_id'];
...
if(isset($_POST['btn-update']))
{
 ...
 $sql_query = "UPDATE volunteer SET 
							...
							pick_up_limit='$pick_up_limit',
							address='$address', 
							volunteer_contact='$volunteer_contact', 
							nights_offering='$nights_offering', 
							max_guests='$max_guests', 
							trip_rounds='$trip_rounds' 
 WHERE volunteer_id=".$_GET['edit_id'];
 // sql query for update data into database
 ...
 if(mysqli_query($connection, $sql_query))
 {
  ...
  window.location.href='adminview_vo.php';
  </script>
  <?php
 }
 else
...
{
 header("Location: adminview_vo.php");
}
?>
