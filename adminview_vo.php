...
{
 $sql_query="DELETE FROM volunteer WHERE volunteer_id=".$_GET['delete_id'];
...
function edt_id(id)
{
 ...
 {
  window.location.href='admin_edit_volunteer.php?edit_id='+id;
 }
}
function delete_id(id)
{
 ...
 {
  window.location.href='adminview_vo.php?delete_id='+id;
 }
}
</script>
</head>
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="adminview.php">Main</a>
		  <a class="navbar-brand" href="#"></a>
		  <a class="navbar-brand" href="adminview_vo.php">Volunteers</a>
		  <a class="navbar-brand" href="adminview_st.php">Students</a>
        </div>
...
<div id="body">
 <div id="content">
    ...
    <table align="center">
    <tr>
    <th colspan="5"><a href="add_volunteer.php">Add Volunteers.</a></th>
    </tr>
	<th>Volunteer ID</th>
	<th>Account ID</th>
    <th>Affiliation</th>
